package net.berlitz.mccourse.fluid;
...
public class ModFluidTypes {
    ...
    public static final RegistryObject<FluidType> SOAP_WATER_FLUID_TYPE = registerFluidType("soap_water_fluid",
            new BaseFluidType(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"),  new ResourceLocation("block/water_overlay"),0xA1E038D0,
