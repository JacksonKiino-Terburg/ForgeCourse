package net.berlitz.mccourse.particle;
...
public class AlexandriteParticles extends TextureSheetParticle {
    ...
    public AlexandriteParticles(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
