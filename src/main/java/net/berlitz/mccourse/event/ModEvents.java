...
import net.berlitz.mccourse.command.ReturnHomeCommand;
import net.berlitz.mccourse.command.SetHomeCommand;
import net.berlitz.mccourse.item.ModItems;
import net.berlitz.mccourse.item.custom.HammerItem;
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        if(event.getType() == VillagerProfession.FARMER)
        {
            ...
            trades.get(2).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD,2),
                    new ItemStack(ModItems.KOHLRABI_SEEDS.get()),
                    10,
                    2,
                    0.02f
            ));
